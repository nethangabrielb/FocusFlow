    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-2">
                ...
                <p className={clsx(
                    "text-lg",
                    userState === 'experienced' ? "text-gray-400" : "text-gray-500"
                )}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {stats.map((stat) => (
                    <div key={stat.label} className={clsx(
                        ...
                        userState === 'experienced' ? "bg-gray-800 border border-gray-700" : "bg-white shadow-xl shadow-gray-200/50"
                    )}>
                        <div className="flex items-center justify-between mb-4">
                            <div className={clsx(
                                "p-3 rounded-xl",
                                userState === 'experienced' ? stat.darkBg : stat.bg
                            )}>
            ...
            <div className={clsx(
                ...
                <div className="space-y-4">
                        ...
                        <div key={task.id} className={clsx(
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className={clsx(
                                    ...
                                    !task.completedAt && (userState === 'experienced' ? "text-gray-200" : "text-gray-900")
                                )}>
                                    {task.title}
                                </span>
                            </div>
                            <span className={clsx(
                                ...
                                userState === 'experienced' ? "bg-gray-800 text-gray-400" : "bg-white text-gray-500 border border-gray-200"
                            )}>
                                {task.category}
                            </span>
                        </div>
                    ...
                    {tasks.length === 0 && (
                        <p className="text-gray-500 text-center py-4">No tasks yet. Get started!</p>
                    )}
                </div>
            </div>
        </div>
